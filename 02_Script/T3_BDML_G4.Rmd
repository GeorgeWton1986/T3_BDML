...
```{r}}
# Crear validación cruzada espacial (5 folds)
set.seed(123)
spatial_folds <- spatial_vfold_cv(train_factors, v = 5, strata = price) 

# Crear receta (puedes agregar preprocesos aquí si quieres)
receta <- recipe(price ~ ., data = train_factors) %>%
  update_role(lon, lat, new_role = "id")  # para que lon y lat no sean predictoras

# Definir modelo CART para regresión
...
# Entrenar con validación cruzada espacial
set.seed(123)
