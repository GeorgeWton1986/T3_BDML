...
mapa_1 <- ggplot(train_localidades_sf) +
  geom_sf(color = "blue", size = 1.5, alpha = 0.7) +
  theme_minimal() +
  labs(title = "Puntos fuera de Chapinero en Bogotá",
       x = "Longitud", y = "Latitud")

ggsave("../04_Views/GRAFICO_Puntos-fuera-chapinero.png", plot = mapa_1, dpi = 150, width = 8, height = 6)

# Mapar formato plano

mapa_2 <- ggplot(train_aptos_sf) +   # Aquí usas el objeto sf
...
ggsave("../04_Views/GRAFICO_Mapa-train.png", plot = mapa_2, dpi = 150, width = 8, height = 6)
```
...
estadisticas_train <- skim(train_localidades)
...
vars_clave_estadisticas <- train_localidades %>%
  select(price,
    year,
    distancia_cai,
    distancia_mall,
